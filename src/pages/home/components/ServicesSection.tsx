...
const services = [
  {
    ...
    description: "Full-stack web applications built with modern frameworks like React, Next.js, and Node.js. Performant, scalable, and beautifully crafted.",
  ...
  },
  {
    ...
    description: "Cross-platform mobile applications for iOS and Android. Native performance with React Native and Flutter, shipped to millions.",
  ...
  },
  {
    ...
    description: "Scalable cloud infrastructure on AWS, GCP, and Azure. From serverless functions to containerized microservices with full CI/CD pipelines.",
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description: "Human-centered design that converts. From wireframes to pixel-perfect interfaces — design systems, prototypes, and usability testing.",
  ...
  },
  {
    ...
    description: "Bring intelligence to your products. LLM integration, computer vision, predictive analytics, and custom model fine-tuning for real business impact.",
  ...
  },
  {
    ...
    title: "DevOps & CI/CD",
    description: "Streamline your development lifecycle. Automated testing, continuous deployment, infrastructure as code, and monitoring that never sleeps.",
